...
* SDKs for Extending ArcGIS Products:
  * [ArcGIS CityEngine SDKs (C++)](https://github.com/esri/cityengine-sdk) ⭐ 220 | 🐛 0 | 📅 2025-12-18 - C++ APIs, documentation, and examples for the Procedural Runtime (PRT).
...
* JavaScript:
  * [Esri/jsapi-resources](https://github.com/Esri/jsapi-resources) ⭐ 764 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-15 - A collection of resources for developers using the ArcGIS API for JavaScript.
  * [ArcGIS REST JS demos](https://github.com/Esri/arcgis-rest-js/tree/master/demos) ⭐ 382 | 🐛 60 | 🌐 TypeScript | 📅 2026-05-16 - Demo apps built by Esri's REST JS maintainers.
...
* Arcade:
  * [ArcGIS Arcade Expression Templates](https://github.com/Esri/arcade-expressions) ⭐ 358 | 🐛 17 | 🌐 JavaScript | 📅 2026-04-08 - Collection of reusable Arcade expressions across all supported profiles.
* [Esri/developer-support](https://github.com/Esri/developer-support) ⭐ 288 | 🐛 7 | 🌐 C# | 📅 2026-05-07 - Community samples to help be successful with all ArcGIS developer products (Python, .NET, JavaScript, Android…).
...
* [EsriJapan/arcgis-dev-resources](https://github.com/EsriJapan/arcgis-dev-resources) ⭐ 10 | 🐛 0 | 🌐 HTML | 📅 2026-05-26 - ArcGIS Developers 開発リソース集 (by Esri Japan).
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,924 | 🐛 547 | 🌐 C++ | 📅 2026-05-26 - Translator library for raster and vector geospatial data formats.
...
* Simplification and generalization:
  * [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,113 | 🐛 139 | 🌐 JavaScript | 📅 2026-05-24 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
...
* Format conversion:
  * [terraformer](https://github.com/terraformer-js/terraformer) ⭐ 234 | 🐛 14 | 🌐 JavaScript | 📅 2026-05-09 - Convert ArcGIS JSON to and from GeoJSON, convert WKT geometries to and from GeoJSON geometries, and other formats.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,113 | 🐛 139 | 🌐 JavaScript | 📅 2026-05-24 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,156 | 🐛 82 | 🌐 TypeScript | 📅 2026-05-20 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,360 | 🐛 304 | 🌐 TypeScript | 📅 2026-05-22 - Geospatial analysis for browsers and Node.js.
...
* [Esri/spatial-framework-for-hadoop](https://github.com/Esri/spatial-framework-for-hadoop) ⭐ 376 | 🐛 26 | 🌐 Java | 📅 2026-05-22 - Allows developers and data scientists to use the Hadoop data processing system for spatial data analysis.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 75,622 | 🐛 153 | 📅 2026-05-23 - A topic-centric list of high-quality open datasets.
* [awesome-semantic-segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,835 | 🐛 17 | 📅 2021-05-08 - Networks by architecture (semantic segmentation, instance aware segmentation, etc.), RNN, GANS, datasets, and more.
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,356 | 🐛 39 | 📅 2026-04-29 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,056 | 🐛 0 | 📅 2026-05-22 - Databases, radar, lidar, web map development, etc.
...
* [awesome-vector-tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,603 | 🐛 2 | 📅 2026-05-12 - Implementations of the Mapbox Vector Tile specification: parsers & generators, clients, apps, and command line tools, CLI utilities, servers, etc.
* [awesome-geojson](https://github.com/tmcw/awesome-geojson) ⭐ 2,492 | 🐛 0 | 📅 2026-02-01 - GeoJSON utilities: operations,editors & viewers, validation, services, conversion, etc.
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,228 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, and contests related to remote sensing change detection.
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,763 | 🐛 11 | 📅 2026-05-10 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
* [awesome-earthobservation-code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,346 | 🐛 1 | 🌐 HTML | 📅 2026-05-13 - Tools, tutorials, code, helpful projects, and links about Earth Observation and Geospatial stuff.
...
You can [file an issue](https://github.com/ArcGIS/awesome-arcgis-developer/issues/new) ⭐ 319 | 🐛 9 | 📅 2026-04-14 to request or suggest a specific resource.

<!--lint disable no-emphasis-as-heading-->

**Contributing**

Esri welcomes contributions from anyone and everyone. You can [issue a pull request](https://github.com/ArcGIS/awesome-arcgis-developer/pulls) ⭐ 319 | 🐛 9 | 📅 2026-04-14 to propose an update, but before doing it, please:

* Check the [contributing guidelines for this repo](origin/CONTRIBUTING.md).
* Take a look at [previously logged issues](https://github.com/ArcGIS/awesome-arcgis-developer/issues) ⭐ 319 | 🐛 9 | 📅 2026-04-14.
