...
* JavaScript:
  ...
  * [ArcGIS REST JS demos](https://github.com/Esri/arcgis-rest-js/tree/master/demos) ⭐ 371 | 🐛 62 | 🌐 TypeScript | 📅 2026-02-06 - Demo apps built by Esri's REST JS maintainers.
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,758 | 🐛 567 | 🌐 C++ | 📅 2026-02-10 - Translator library for raster and vector geospatial data formats.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,224 | 🐛 282 | 🌐 TypeScript | 📅 2026-02-08 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 72,702 | 🐛 135 | 📅 2026-01-30 - A topic-centric list of high-quality open datasets.
* [awesome-semantic-segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,812 | 🐛 17 | 📅 2021-05-08 - Networks by architecture (semantic segmentation, instance aware segmentation, etc.), RNN, GANS, datasets, and more.
...
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,751 | 🐛 2 | 📅 2026-01-13 - Databases, radar, lidar, web map development, etc.
...
* [awesome-json-datasets](https://github.com/jdorfman/awesome-json-datasets) ⭐ 3,548 | 🐛 2 | 🌐 JavaScript | 📅 2024-12-13 - JSON datasets that don't require authentication about: climate, crime, government, NASA, travel, etc.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,112 | 🐛 5 | 📅 2025-11-17 - List of datasets, codes, and contests related to remote sensing change detection.
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,697 | 🐛 9 | 📅 2025-11-28 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
