...
* Integrations & Plugins (third-party libraries):
  * [Esri-gl](https://github.com/muimsd/esri-gl) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-08 - A community-maintained plugin that enables the use of ArcGIS services in Mapbox GL JS and MapLibre GL JS applications.
...
* JavaScript:
  ...
  * [ArcGIS REST JS demos](https://github.com/Esri/arcgis-rest-js/tree/master/demos) ⭐ 372 | 🐛 60 | 🌐 TypeScript | 📅 2026-03-08 - Demo apps built by Esri's REST JS maintainers.
...
* [Esri/developer-support](https://github.com/Esri/developer-support) ⭐ 286 | 🐛 6 | 🌐 C# | 📅 2026-03-05 - Community samples to help be successful with all ArcGIS developer products (Python, .NET, JavaScript, Android…).
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,790 | 🐛 554 | 🌐 C++ | 📅 2026-03-08 - Translator library for raster and vector geospatial data formats.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,069 | 🐛 144 | 🌐 JavaScript | 📅 2025-09-30 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,105 | 🐛 79 | 🌐 TypeScript | 📅 2026-02-27 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,278 | 🐛 294 | 🌐 TypeScript | 📅 2026-03-05 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 73,324 | 🐛 140 | 📅 2026-03-04 - A topic-centric list of high-quality open datasets.
* [awesome-semantic-segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,819 | 🐛 17 | 📅 2021-05-08 - Networks by architecture (semantic segmentation, instance aware segmentation, etc.), RNN, GANS, datasets, and more.
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,219 | 🐛 18 | 📅 2026-03-06 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,784 | 🐛 1 | 📅 2026-02-15 - Databases, radar, lidar, web map development, etc.
...
* [awesome-vector-tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,585 | 🐛 4 | 📅 2025-11-17 - Implementations of the Mapbox Vector Tile specification: parsers & generators, clients, apps, and command line tools, CLI utilities, servers, etc.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,135 | 🐛 2 | 📅 2026-02-13 - List of datasets, codes, and contests related to remote sensing change detection.
...
* [awesome-earthobservation-code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,321 | 🐛 0 | 🌐 HTML | 📅 2026-02-01 - Tools, tutorials, code, helpful projects, and links about Earth Observation and Geospatial stuff.
