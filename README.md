...
* Integrations & Plugins (third-party libraries):
  * [Esri-gl](https://github.com/muimsd/esri-gl) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-13 - A community-maintained plugin that enables the use of ArcGIS services in Mapbox GL JS and MapLibre GL JS applications.
...
* JavaScript:
  ...
  * [ArcGIS REST JS demos](https://github.com/Esri/arcgis-rest-js/tree/master/demos) ⭐ 383 | 🐛 62 | 🌐 TypeScript | 📅 2026-06-13 - Demo apps built by Esri's REST JS maintainers.
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,942 | 🐛 544 | 🌐 C++ | 📅 2026-06-14 - Translator library for raster and vector geospatial data formats.
...
* Simplification and generalization:
  * [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,130 | 🐛 138 | 🌐 JavaScript | 📅 2026-06-13 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,130 | 🐛 138 | 🌐 JavaScript | 📅 2026-06-13 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,172 | 🐛 32 | 🌐 TypeScript | 📅 2026-06-11 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 75,950 | 🐛 153 | 📅 2026-06-11 - A topic-centric list of high-quality open datasets.
...
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,385 | 🐛 42 | 📅 2026-04-29 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,080 | 🐛 0 | 📅 2026-06-13 - Databases, radar, lidar, web map development, etc.
...
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,777 | 🐛 9 | 📅 2026-05-26 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
