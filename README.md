...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,922 | 🐛 545 | 🌐 C++ | 📅 2026-05-24 - Translator library for raster and vector geospatial data formats.
...
* Simplification and generalization:
  * [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,111 | 🐛 142 | 🌐 JavaScript | 📅 2026-05-23 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 75,605 | 🐛 152 | 📅 2026-05-23 - A topic-centric list of high-quality open datasets.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,226 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, and contests related to remote sensing change detection.
