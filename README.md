...
* JavaScript:
  ...
  * [ArcGIS REST JS demos](https://github.com/Esri/arcgis-rest-js/tree/master/demos) ⭐ 380 | 🐛 60 | 🌐 TypeScript | 📅 2026-05-16 - Demo apps built by Esri's REST JS maintainers.
...
* [EsriJapan/arcgis-dev-resources](https://github.com/EsriJapan/arcgis-dev-resources) ⭐ 10 | 🐛 0 | 🌐 HTML | 📅 2026-04-13 - ArcGIS Developers 開発リソース集 (by Esri Japan).
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,923 | 🐛 554 | 🌐 C++ | 📅 2026-05-25 - Translator library for raster and vector geospatial data formats.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,113 | 🐛 139 | 🌐 JavaScript | 📅 2026-05-24 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,156 | 🐛 81 | 🌐 TypeScript | 📅 2026-05-20 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,361 | 🐛 304 | 🌐 TypeScript | 📅 2026-05-22 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 75,615 | 🐛 153 | 📅 2026-05-23 - A topic-centric list of high-quality open datasets.
...
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,354 | 🐛 39 | 📅 2026-04-29 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,055 | 🐛 0 | 📅 2026-05-22 - Databases, radar, lidar, web map development, etc.
...
* [awesome-geojson](https://github.com/tmcw/awesome-geojson) ⭐ 2,491 | 🐛 0 | 📅 2026-02-01 - GeoJSON utilities: operations,editors & viewers, validation, services, conversion, etc.
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,227 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, and contests related to remote sensing change detection.
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,762 | 🐛 11 | 📅 2026-05-10 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
* [awesome-earthobservation-code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,345 | 🐛 1 | 🌐 HTML | 📅 2026-05-13 - Tools, tutorials, code, helpful projects, and links about Earth Observation and Geospatial stuff.
