...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,792 | 🐛 546 | 🌐 C++ | 📅 2026-03-10 - Translator library for raster and vector geospatial data formats.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,070 | 🐛 144 | 🌐 JavaScript | 📅 2025-09-30 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,107 | 🐛 80 | 🌐 TypeScript | 📅 2026-02-27 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,280 | 🐛 293 | 🌐 TypeScript | 📅 2026-03-05 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 73,361 | 🐛 140 | 📅 2026-03-10 - A topic-centric list of high-quality open datasets.
* [awesome-semantic-segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,822 | 🐛 17 | 📅 2021-05-08 - Networks by architecture (semantic segmentation, instance aware segmentation, etc.), RNN, GANS, datasets, and more.
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,224 | 🐛 20 | 📅 2026-03-06 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,789 | 🐛 1 | 📅 2026-03-09 - Databases, radar, lidar, web map development, etc.
...
* [awesome-vector-tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,587 | 🐛 4 | 📅 2025-11-17 - Implementations of the Mapbox Vector Tile specification: parsers & generators, clients, apps, and command line tools, CLI utilities, servers, etc.
* [awesome-geojson](https://github.com/tmcw/awesome-geojson) ⭐ 2,469 | 🐛 2 | 📅 2026-02-01 - GeoJSON utilities: operations,editors & viewers, validation, services, conversion, etc.
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,139 | 🐛 2 | 📅 2026-02-13 - List of datasets, codes, and contests related to remote sensing change detection.
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,716 | 🐛 9 | 📅 2025-11-28 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
