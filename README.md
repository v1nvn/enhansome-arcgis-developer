...
* JavaScript:
  ...
  * [ArcGIS REST JS demos](https://github.com/Esri/arcgis-rest-js/tree/master/demos) ⭐ 377 | 🐛 59 | 🌐 TypeScript | 📅 2026-04-14 - Demo apps built by Esri's REST JS maintainers.
...
* [Esri/developer-support](https://github.com/Esri/developer-support) ⭐ 287 | 🐛 7 | 🌐 C# | 📅 2026-04-14 - Community samples to help be successful with all ArcGIS developer products (Python, .NET, JavaScript, Android…).
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,864 | 🐛 549 | 🌐 C++ | 📅 2026-04-14 - Translator library for raster and vector geospatial data formats.
...
* Simplification and generalization:
  * [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,090 | 🐛 145 | 🌐 JavaScript | 📅 2025-09-30 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
...
* Format conversion:
  * [terraformer](https://github.com/terraformer-js/terraformer) ⭐ 232 | 🐛 11 | 🌐 JavaScript | 📅 2026-04-14 - Convert ArcGIS JSON to and from GeoJSON, convert WKT geometries to and from GeoJSON geometries, and other formats.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,090 | 🐛 145 | 🌐 JavaScript | 📅 2025-09-30 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,128 | 🐛 79 | 🌐 TypeScript | 📅 2026-04-02 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,321 | 🐛 298 | 🌐 TypeScript | 📅 2026-03-29 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 74,006 | 🐛 146 | 📅 2026-04-14 - A topic-centric list of high-quality open datasets.
...
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,302 | 🐛 25 | 📅 2026-03-29 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,961 | 🐛 0 | 📅 2026-04-11 - Databases, radar, lidar, web map development, etc.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,182 | 🐛 2 | 📅 2026-03-14 - List of datasets, codes, and contests related to remote sensing change detection.
...
You can [file an issue](https://github.com/ArcGIS/awesome-arcgis-developer/issues/new) ⭐ 315 | 🐛 9 | 📅 2026-04-14 to request or suggest a specific resource.

<!--lint disable no-emphasis-as-heading-->

**Contributing**

Esri welcomes contributions from anyone and everyone. You can [issue a pull request](https://github.com/ArcGIS/awesome-arcgis-developer/pulls) ⭐ 315 | 🐛 9 | 📅 2026-04-14 to propose an update, but before doing it, please:

* Check the [contributing guidelines for this repo](origin/CONTRIBUTING.md).
* Take a look at [previously logged issues](https://github.com/ArcGIS/awesome-arcgis-developer/issues) ⭐ 315 | 🐛 9 | 📅 2026-04-14.
