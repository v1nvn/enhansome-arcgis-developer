...
* JavaScript:
  * [Esri/jsapi-resources](https://github.com/Esri/jsapi-resources) ⭐ 762 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-15 - A collection of resources for developers using the ArcGIS API for JavaScript.
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,919 | 🐛 541 | 🌐 C++ | 📅 2026-05-21 - Translator library for raster and vector geospatial data formats.
...
* Simplification and generalization:
  * [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,111 | 🐛 141 | 🌐 JavaScript | 📅 2026-05-20 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,359 | 🐛 304 | 🌐 TypeScript | 📅 2026-05-21 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 75,583 | 🐛 152 | 📅 2026-05-19 - A topic-centric list of high-quality open datasets.
...
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,353 | 🐛 39 | 📅 2026-04-29 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,054 | 🐛 1 | 📅 2026-05-18 - Databases, radar, lidar, web map development, etc.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,218 | 🐛 2 | 📅 2026-04-16 - List of datasets, codes, and contests related to remote sensing change detection.
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,760 | 🐛 11 | 📅 2026-05-10 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
