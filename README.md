...
* Integrations & Plugins (third-party libraries):
  * [Esri-gl](https://github.com/muimsd/esri-gl) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-01 - A community-maintained plugin that enables the use of ArcGIS services in Mapbox GL JS and MapLibre GL JS applications.
...
* Arcade:
  * [ArcGIS Arcade Expression Templates](https://github.com/Esri/arcade-expressions) ⭐ 356 | 🐛 17 | 🌐 JavaScript | 📅 2026-04-01 - Collection of reusable Arcade expressions across all supported profiles.
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,841 | 🐛 542 | 🌐 C++ | 📅 2026-04-01 - Translator library for raster and vector geospatial data formats.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,302 | 🐛 295 | 🌐 TypeScript | 📅 2026-03-29 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 73,787 | 🐛 142 | 📅 2026-04-01 - A topic-centric list of high-quality open datasets.
* [awesome-semantic-segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,831 | 🐛 17 | 📅 2021-05-08 - Networks by architecture (semantic segmentation, instance aware segmentation, etc.), RNN, GANS, datasets, and more.
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,264 | 🐛 20 | 📅 2026-03-29 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,896 | 🐛 2 | 📅 2026-04-01 - Databases, radar, lidar, web map development, etc.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,165 | 🐛 2 | 📅 2026-03-14 - List of datasets, codes, and contests related to remote sensing change detection.
...
* [awesome-earthobservation-code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,332 | 🐛 1 | 🌐 HTML | 📅 2026-02-01 - Tools, tutorials, code, helpful projects, and links about Earth Observation and Geospatial stuff.
