...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,800 | 🐛 547 | 🌐 C++ | 📅 2026-03-13 - Translator library for raster and vector geospatial data formats.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,283 | 🐛 295 | 🌐 TypeScript | 📅 2026-03-13 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 73,390 | 🐛 140 | 📅 2026-03-10 - A topic-centric list of high-quality open datasets.
...
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,227 | 🐛 22 | 📅 2026-03-06 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,791 | 🐛 0 | 📅 2026-03-11 - Databases, radar, lidar, web map development, etc.
...
* [awesome-vector-tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,590 | 🐛 4 | 📅 2025-11-17 - Implementations of the Mapbox Vector Tile specification: parsers & generators, clients, apps, and command line tools, CLI utilities, servers, etc.
...
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,142 | 🐛 2 | 📅 2026-02-13 - List of datasets, codes, and contests related to remote sensing change detection.
