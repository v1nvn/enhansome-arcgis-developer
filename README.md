...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,753 | 🐛 563 | 🌐 C++ | 📅 2026-02-07 - Translator library for raster and vector geospatial data formats.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,217 | 🐛 282 | 🌐 TypeScript | 📅 2026-02-08 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 72,662 | 🐛 135 | 📅 2026-01-30 - A topic-centric list of high-quality open datasets.
...
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,750 | 🐛 1 | 📅 2026-01-13 - Databases, radar, lidar, web map development, etc.
...
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,696 | 🐛 9 | 📅 2025-11-28 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
...
You can [file an issue](https://github.com/ArcGIS/awesome-arcgis-developer/issues/new) ⭐ 307 | 🐛 9 | 📅 2025-10-21 to request or suggest a specific resource.

<!--lint disable no-emphasis-as-heading-->

**Contributing**

Esri welcomes contributions from anyone and everyone. You can [issue a pull request](https://github.com/ArcGIS/awesome-arcgis-developer/pulls) ⭐ 307 | 🐛 9 | 📅 2025-10-21 to propose an update, but before doing it, please:

* Check the [contributing guidelines for this repo](origin/CONTRIBUTING.md).
* Take a look at [previously logged issues](https://github.com/ArcGIS/awesome-arcgis-developer/issues) ⭐ 307 | 🐛 9 | 📅 2025-10-21.
