...
* [EsriJapan/arcgis-dev-resources](https://github.com/EsriJapan/arcgis-dev-resources) ⭐ 10 | 🐛 0 | 🌐 HTML | 📅 2026-06-08 - ArcGIS Developers 開発リソース集 (by Esri Japan).
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,941 | 🐛 555 | 🌐 C++ | 📅 2026-06-08 - Translator library for raster and vector geospatial data formats.
...
* Simplification and generalization:
  * [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,126 | 🐛 138 | 🌐 JavaScript | 📅 2026-06-06 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,373 | 🐛 306 | 🌐 TypeScript | 📅 2026-06-06 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 75,877 | 🐛 153 | 📅 2026-06-04 - A topic-centric list of high-quality open datasets.
...
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,072 | 🐛 0 | 📅 2026-06-04 - Databases, radar, lidar, web map development, etc.
...
* [awesome-vector-tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,607 | 🐛 2 | 📅 2026-05-12 - Implementations of the Mapbox Vector Tile specification: parsers & generators, clients, apps, and command line tools, CLI utilities, servers, etc.
...
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,773 | 🐛 9 | 📅 2026-05-26 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
