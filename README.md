...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,812 | 🐛 550 | 🌐 C++ | 📅 2026-03-19 - Translator library for raster and vector geospatial data formats.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,289 | 🐛 292 | 🌐 TypeScript | 📅 2026-03-16 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 73,494 | 🐛 138 | 📅 2026-03-17 - A topic-centric list of high-quality open datasets.
...
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,801 | 🐛 3 | 📅 2026-03-11 - Databases, radar, lidar, web map development, etc.
...
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,723 | 🐛 10 | 📅 2025-11-28 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
