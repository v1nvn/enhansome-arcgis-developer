...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,924 | 🐛 549 | 🌐 C++ | 📅 2026-05-26 - Translator library for raster and vector geospatial data formats.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,113 | 🐛 139 | 🌐 JavaScript | 📅 2026-05-24 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,157 | 🐛 84 | 🌐 TypeScript | 📅 2026-05-20 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 75,626 | 🐛 153 | 📅 2026-05-23 - A topic-centric list of high-quality open datasets.
...
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,358 | 🐛 39 | 📅 2026-04-29 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 5,056 | 🐛 1 | 📅 2026-05-22 - Databases, radar, lidar, web map development, etc.
