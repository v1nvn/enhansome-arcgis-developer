...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,816 | 🐛 549 | 🌐 C++ | 📅 2026-03-20 - Translator library for raster and vector geospatial data formats.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,291 | 🐛 292 | 🌐 TypeScript | 📅 2026-03-16 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 73,508 | 🐛 139 | 📅 2026-03-17 - A topic-centric list of high-quality open datasets.
...
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,240 | 🐛 24 | 📅 2026-03-06 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,803 | 🐛 1 | 📅 2026-03-20 - Databases, radar, lidar, web map development, etc.
