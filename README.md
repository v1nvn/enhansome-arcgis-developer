...
* Integrations & Plugins (third-party libraries):
  * [Esri-gl](https://github.com/muimsd/esri-gl) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-20 - A community-maintained plugin that enables the use of ArcGIS services in Mapbox GL JS and MapLibre GL JS applications.
...
* JavaScript:
  * [Esri/jsapi-resources](https://github.com/Esri/jsapi-resources) ⭐ 754 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-18 - A collection of resources for developers using the ArcGIS API for JavaScript.
  * [ArcGIS REST JS demos](https://github.com/Esri/arcgis-rest-js/tree/master/demos) ⭐ 372 | 🐛 61 | 🌐 TypeScript | 📅 2026-02-19 - Demo apps built by Esri's REST JS maintainers.
...
* Arcade:
  * [ArcGIS Arcade Expression Templates](https://github.com/Esri/arcade-expressions) ⭐ 349 | 🐛 17 | 🌐 JavaScript | 📅 2026-01-10 - Collection of reusable Arcade expressions across all supported profiles.
* [Esri/developer-support](https://github.com/Esri/developer-support) ⭐ 286 | 🐛 6 | 🌐 C# | 📅 2025-12-31 - Community samples to help be successful with all ArcGIS developer products (Python, .NET, JavaScript, Android…).
...
* Core geospatial processing libraries:
  * [gdal](https://github.com/OSGeo/gdal) ⭐ 5,777 | 🐛 550 | 🌐 C++ | 📅 2026-02-21 - Translator library for raster and vector geospatial data formats.
...
* Simplification and generalization:
  * [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,062 | 🐛 143 | 🌐 JavaScript | 📅 2025-09-30 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
...
* Format conversion:
  * [terraformer](https://github.com/terraformer-js/terraformer) ⭐ 231 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-14 - Convert ArcGIS JSON to and from GeoJSON, convert WKT geometries to and from GeoJSON geometries, and other formats.
...
* [Mapshaper](https://github.com/mbloch/mapshaper) ⭐ 4,062 | 🐛 143 | 🌐 JavaScript | 📅 2025-09-30 - Web application to simplify shapes, edit attribute data, clip, erase, dissolve, filter, etc. Supported file formats: Shapefile, GeoJSON, TopoJSON, and CSV files.
* [geojson.io](https://github.com/mapbox/geojson.io) ⭐ 2,097 | 🐛 83 | 🌐 TypeScript | 📅 2026-02-13 - Web application to visualize, generate, and edit geospatial vector data. Supports GeoJSON, TopoJSON, CSV, KML, WKT, and Shapefile.
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,246 | 🐛 288 | 🌐 TypeScript | 📅 2026-02-18 - Geospatial analysis for browsers and Node.js.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 72,943 | 🐛 135 | 📅 2026-02-17 - A topic-centric list of high-quality open datasets.
* [awesome-semantic-segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,810 | 🐛 17 | 📅 2021-05-08 - Networks by architecture (semantic segmentation, instance aware segmentation, etc.), RNN, GANS, datasets, and more.
* [awesome-gis](https://github.com/sshuair/awesome-gis) ⭐ 5,196 | 🐛 17 | 📅 2026-02-06 - GIS, remote sensing, 3D apps, Web Map Servers, Geospatial libraries, Open Standards, data, etc.
* [awesome-geospatial](https://github.com/sacridini/Awesome-Geospatial) ⭐ 4,762 | 🐛 0 | 📅 2026-02-15 - Databases, radar, lidar, web map development, etc.
...
* [awesome-json-datasets](https://github.com/jdorfman/awesome-json-datasets) ⭐ 3,551 | 🐛 2 | 🌐 JavaScript | 📅 2024-12-13 - JSON datasets that don't require authentication about: climate, crime, government, NASA, travel, etc.
* [awesome-vector-tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,581 | 🐛 3 | 📅 2025-11-17 - Implementations of the Mapbox Vector Tile specification: parsers & generators, clients, apps, and command line tools, CLI utilities, servers, etc.
* [awesome-geojson](https://github.com/tmcw/awesome-geojson) ⭐ 2,462 | 🐛 2 | 📅 2026-02-01 - GeoJSON utilities: operations,editors & viewers, validation, services, conversion, etc.
* [awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,120 | 🐛 2 | 📅 2026-02-13 - List of datasets, codes, and contests related to remote sensing change detection.
* [awesome-open-geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,706 | 🐛 9 | 📅 2025-11-28 - Curated from repositories that make our lives as geoscientists, hackers, and data wranglers easier or just more awesome.
* [awesome-earthobservation-code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,317 | 🐛 0 | 🌐 HTML | 📅 2026-02-01 - Tools, tutorials, code, helpful projects, and links about Earth Observation and Geospatial stuff.
...
You can [file an issue](https://github.com/ArcGIS/awesome-arcgis-developer/issues/new) ⭐ 309 | 🐛 9 | 📅 2025-10-21 to request or suggest a specific resource.

<!--lint disable no-emphasis-as-heading-->

**Contributing**

Esri welcomes contributions from anyone and everyone. You can [issue a pull request](https://github.com/ArcGIS/awesome-arcgis-developer/pulls) ⭐ 309 | 🐛 9 | 📅 2025-10-21 to propose an update, but before doing it, please:

* Check the [contributing guidelines for this repo](origin/CONTRIBUTING.md).
* Take a look at [previously logged issues](https://github.com/ArcGIS/awesome-arcgis-developer/issues) ⭐ 309 | 🐛 9 | 📅 2025-10-21.
